...
✨ Fitur yang Tersedia
Tampilkan semua menu & stok
Cari menu berdasarkan ID
Tampilkan menu per kategori (Makanan / Minuman / Dessert)
Tambah stok menu tertentu
Kurangi stok (simulasi penjualan) + hitung pendapatan
Tampilkan menu stok menipis (stok ≤ 5)
Tampilkan menu stok habis
🚀 Cara Menjalankan Program
Persiapan
Pastikan sudah terinstall JDK 8 atau lebih baru
